...
public final class Values {
  ...
  public Values(final ForgeConfigSpec.Builder builder){
    ...
    compressor_required_energy            = builder.defineInRange("Compressor",
                                              DEFAULT_COMPRESSOR_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    gem_converter_required_energy         = builder.defineInRange("Gem Converter",
                                              DEFAULT_GEM_CONVERTER_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    inverter_required_energy              = builder.defineInRange("Inverter",
                                              DEFAULT_INVERTER_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    magic_infuser_required_energy         = builder.defineInRange("Magic Infuser",
                                              DEFAULT_MAGIC_INFUSER_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    identifier_required_energy            = builder.defineInRange("Identifier",
                                              DEFAULT_IDENTIFIER_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    portal_control_panel_required_energy  = builder.defineInRange("Portal Control Panel",
                                              DEFAULT_PORTAL_REQUIRED_ENERGY, 0, Integer.MAX_VALUE);
    ...
    crystal_matter_generator_required_energy = builder.defineInRange("Crystal Matter Generator",
    ...
    compressor_work_time    = builder.defineInRange("Compressor",    DEFAULT_COMPRESSOR_WORK_TIME, 0, Integer.MAX_VALUE);
    gem_converter_work_time = builder.defineInRange("Gem Converter", DEFAULT_GEM_CONVERTER_WORK_TIME, 0, Integer.MAX_VALUE);
    inverter_work_time      = builder.defineInRange("Inverter",      DEFAULT_INVERTER_WORK_TIME, 0, Integer.MAX_VALUE);
    magic_infuser_work_time = builder.defineInRange("Magic Infuser", DEFAULT_MAGIC_INFUSER_WORK_TIME, 0, Integer.MAX_VALUE);
    identifier_work_time    = builder.defineInRange("Identifier",    DEFAULT_IDENTIFIER_WORK_TIME, 0, Integer.MAX_VALUE);
    crystal_matter_generator_work_time = builder.defineInRange("Crystal Matter Generator",
