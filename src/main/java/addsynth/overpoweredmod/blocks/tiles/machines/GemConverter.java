...
public final class GemConverter extends MachineBlockTileEntity {
  ...
  public final boolean onBlockActivated(World world, BlockPos pos,IBlockState state,EntityPlayer player,EnumHand hand,EnumFacing side,float xHit,float yHit,float zHit){
    if(world.isRemote == false){
      player.openGui(OverpoweredMod.instance,GuiHandler.GEM_CONVERTER, world,pos.getX(),pos.getY(),pos.getZ());
    }
    return true;
  }
