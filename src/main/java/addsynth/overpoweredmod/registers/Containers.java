...
public final class Containers {
  ...
  public static final ContainerType<ContainerInverter>           INVERTER                   = new ContainerType<>(ContainerInverter::new);
  public static final ContainerType<ContainerGemConverter>       GEM_CONVERTER              = new ContainerType<>(ContainerGemConverter::new);
  public static final ContainerType<ContainerMagicInfuser>       MAGIC_INFUSER              = new ContainerType<>(ContainerMagicInfuser::new);
  public static final ContainerType<ContainerIdentifier>         IDENTIFIER                 = new ContainerType<>(ContainerIdentifier::new);
  public static final ContainerType<ContainerOreRefinery>        ADVANCED_ORE_REFINERY      = new ContainerType<>(ContainerOreRefinery::new);
  public static final ContainerType<ContainerCrystalGenerator>   CRYSTAL_MATTER_GENERATOR   = new ContainerType<>(ContainerCrystalGenerator::new);
  
  public static final ContainerType<ContainerPortalControlPanel> PORTAL_CONTROL_PANEL       = new ContainerType<>(ContainerPortalControlPanel::new);
  public static final ContainerType<ContainerPortalFrame>        PORTAL_FRAME               = new ContainerType<>(ContainerPortalFrame::new);

  public static final ContainerType<ContainerLaserHousing>       LASER_HOUSING              = new ContainerType<>(ContainerLaserHousing::new);

  public static final ContainerType<ContainerFusionChamber>      FUSION_CHAMBER             = new ContainerType<>(ContainerFusionChamber::new);
