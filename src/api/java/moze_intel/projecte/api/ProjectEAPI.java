...
public final class ProjectEAPI
{
	...
	public static IEMCProxy getEMCProxy()
	{
		if (emcProxy == null)
		{
			...
			{
				log.error("Error retrieving EMCProxyImpl, ProjectE may be absent, damaged, or outdated.");
			}
		}
		return emcProxy;
	}
	...
	public static IConversionProxy getConversionProxy()
	{
		if (recipeProxy == null)
		{
			...
			{
				log.error("Error retrieving ConversionProxyImpl, ProjectE may be absent, damaged, or outdated.");
			}
		}
		return recipeProxy;
	}
	...
	public static ITransmutationProxy getTransmutationProxy()
	{
		if (transProxy == null)
		{
			...
			{
				log.error("Error retrieving TransmutationProxyImpl, ProjectE may be absent, damaged, or outdated.");
			}
		}
		return transProxy;
	}
	...
	public static IBlacklistProxy getBlacklistProxy()
	{
		if (blacklistProxy == null)
		{
			...
			{
				log.error("Error retrieving BlacklistProxyImpl, ProjectE may be absent, damaged, or outdated.");
			}
		}
